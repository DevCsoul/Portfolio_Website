...
export const aboutParagraphs = [
  "In college, I co-founded a three-person freelance team where we divided and conquered based on our strengths. I stepped up to own the frontend and web design, building custom, and high-end interfaces for everything from points-based web applications to pharmaceutical landing pages",

  "As project requirements grew, I continued refining my skill set to ensure every digital product delivered both stunning visuals and seamless interactivity",
  ...
  "When I'm not coding, I'm usually enjoying a good cup of coffee with music, gaming, editing videos, or writing about my design and frontend insights",
]